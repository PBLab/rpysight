...
//! and taken directly from the RustBio project
//! (https://github.com/rust-bio/rust-bio/blob/c29375715a047dce38c516b1be609d67a855157c/src/data_structures/interval_tree/array_backed_interval_tree.rs).
//!
